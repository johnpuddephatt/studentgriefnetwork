<header class="absolute top-0 left-0 z-20 w-full bg-transparent">
  <div class="container flex flex-row w-full py-10 mx-auto lg:items-center">
    ...
    <nav
      class="nav fixed inset-0 transform translate-x-[100%] lg:translate-x-0 ml-auto p-12 lowercase bg-white lg:bg-transparent lg:static flex flex-col justify-end lg:flex-row text-blue">
