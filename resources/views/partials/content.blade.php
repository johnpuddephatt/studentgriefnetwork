<article
  class="bg-white bg-opacity-40 shadow-lg relative overflow-hidden @if(in_array(get_post_format(),['video','audio'])) row-span-2 col-span-2 @else row-span-3 col-span-1 @endif">
